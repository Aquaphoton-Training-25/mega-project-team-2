...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.Manual_Button.setGeometry(QtCore.QRect(10, 290, 111, 41))
        font = QtGui.QFont()
        font.setPointSize(12)
        font.setBold(True)
        self.Manual_Button.setFont(font)
        self.Manual_Button.setStyleSheet("background-color: rgb(0, 255, 255);\n"
"")
        self.Manual_Button.setObjectName("Manual_Button")
        self.Autonomous_Button = QtWidgets.QPushButton(parent=self.centralwidget)
        self.Autonomous_Button.setGeometry(QtCore.QRect(10, 340, 111, 41))
        font = QtGui.QFont()
        font.setPointSize(12)
        font.setBold(True)
        self.Autonomous_Button.setFont(font)
        self.Autonomous_Button.setStyleSheet("background-color: rgb(0, 255, 255);\n"
"")
        self.Autonomous_Button.setObjectName("Autonomous_Button")
        self.CameraFeed = QtWidgets.QLabel(parent=self.centralwidget)
        self.CameraFeed.setGeometry(QtCore.QRect(10, 30, 511, 231))
        ...
        self.ScreenShot.setGeometry(QtCore.QRect(530, 30, 101, 51))
        font = QtGui.QFont()
        font.setPointSize(12)
        font.setBold(True)
        self.ScreenShot.setFont(font)
        self.ScreenShot.setStyleSheet("background-color: rgb(0, 255, 255);\n"
"\n"
"")
        ...
        self.CV_task1.setGeometry(QtCore.QRect(530, 150, 101, 51))
        font = QtGui.QFont()
        font.setPointSize(12)
        font.setBold(True)
        self.CV_task1.setFont(font)
        self.CV_task1.setStyleSheet("background-color: rgb(0, 255, 255);")
        self.CV_task1.setObjectName("CV_task1")
        self.CV_task2 = QtWidgets.QPushButton(parent=self.centralwidget)
        self.CV_task2.setGeometry(QtCore.QRect(530, 210, 101, 51))
        font = QtGui.QFont()
        font.setPointSize(12)
        font.setBold(True)
        self.CV_task2.setFont(font)
        self.CV_task2.setStyleSheet("background-color: rgb(0, 255, 255);\n"
"")
        self.CV_task2.setObjectName("CV_task2")
        self.Sonar = QtWidgets.QLabel(parent=self.centralwidget)
        self.Sonar.setGeometry(QtCore.QRect(480, 350, 71, 31))
        font = QtGui.QFont()
        font.setPointSize(12)
        font.setBold(True)
...
"")
        ...
        self.Voltage.setGeometry(QtCore.QRect(560, 310, 71, 31))
        font = QtGui.QFont()
        font.setPointSize(12)
        font.setBold(True)
        ...
        self.Current.setGeometry(QtCore.QRect(560, 350, 71, 31))
        font = QtGui.QFont()
        font.setPointSize(12)
        font.setBold(True)
        ...
        self.Speed.setGeometry(QtCore.QRect(480, 310, 71, 31))
        font = QtGui.QFont()
        font.setPointSize(12)
        font.setBold(True)
        ...
        self.connectivity_indicator.setGeometry(QtCore.QRect(580, 400, 31, 21))
        font = QtGui.QFont()
        font.setPointSize(5)
        font.setBold(True)
...
"background-color: rgb(255, 0, 0);")
        ...
        self.Distance_Edit.setGeometry(QtCore.QRect(180, 400, 91, 20))
        font = QtGui.QFont()
        font.setBold(True)
        self.Distance_Edit.setFont(font)
        self.Distance_Edit.setStyleSheet("background-color: rgb(170, 255, 255);")
        ...
        self.LowSpeed_Button.setGeometry(QtCore.QRect(290, 400, 45, 21))
        font = QtGui.QFont()
        font.setPointSize(7)
        font.setBold(True)
        self.LowSpeed_Button.setFont(font)
        self.LowSpeed_Button.setStyleSheet("background-color: rgb(0, 255, 255);\n"
"")
        ...
        self.MediumSpeed_Button.setGeometry(QtCore.QRect(340, 400, 45, 21))
        font = QtGui.QFont()
        font.setPointSize(7)
        font.setBold(True)
        self.MediumSpeed_Button.setFont(font)
        self.MediumSpeed_Button.setStyleSheet("background-color: rgb(0, 255, 255);\n"
"")
        ...
        self.HighSpeed_Button.setGeometry(QtCore.QRect(390, 400, 45, 21))
        font = QtGui.QFont()
        font.setPointSize(7)
        font.setBold(True)
        self.HighSpeed_Button.setFont(font)
        self.HighSpeed_Button.setStyleSheet("background-color: rgb(0, 255, 255);\n"
"")
        self.HighSpeed_Button.setObjectName("HighSpeed_Button")
        self.Direction = QtWidgets.QLabel(parent=self.centralwidget)
        self.Direction.setGeometry(QtCore.QRect(480, 390, 71, 31))
        font = QtGui.QFont()
        font.setPointSize(12)
        font.setBold(True)
        ...
        self.Forwrd_Button.setGeometry(QtCore.QRect(280, 290, 35, 31))
        self.Forwrd_Button.setFocusPolicy(QtCore.Qt.FocusPolicy.NoFocus)
        self.Forwrd_Button.setAutoFillBackground(False)
        self.Forwrd_Button.setStyleSheet("background-color: rgb(0, 255, 255);\n"
"border-radius: 10px;\n"
...
"")
        ...
        self.Right_Button.setGeometry(QtCore.QRect(320, 320, 35, 31))
        self.Right_Button.setFocusPolicy(QtCore.Qt.FocusPolicy.NoFocus)
        self.Right_Button.setAutoFillBackground(False)
        self.Right_Button.setStyleSheet("background-color: rgb(0, 255, 255);\n"
"border: 2px solid black;\n"
"border-radius: 10px;")
        ...
        self.Left_Button.setGeometry(QtCore.QRect(240, 320, 35, 31))
        self.Left_Button.setFocusPolicy(QtCore.Qt.FocusPolicy.NoFocus)
        self.Left_Button.setAutoFillBackground(False)
        self.Left_Button.setStyleSheet("background-color: rgb(0, 255, 255);\n"
"border: 2px solid black;\n"
"border-radius: 10px;\n"
"\n"
"")
        ...
        self.Backward_Button.setGeometry(QtCore.QRect(280, 350, 35, 31))
        self.Backward_Button.setFocusPolicy(QtCore.Qt.FocusPolicy.NoFocus)
        self.Backward_Button.setAutoFillBackground(False)
        self.Backward_Button.setStyleSheet("background-color: rgb(0, 255, 255);\n"
"border: 2px solid black;\n"
"border-radius: 10px;")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.Autonomous_Button.setText(_translate("MainWindow", "Autonomous"))

...
class DepthMap(GroundTruth):
    ...
    def draw_epipolar_lines(self):
        ...
        for p1, p2 in zip(points1, points2):
            cv2.circle(img1_rgb, tuple(np.int32(p1).tolist()), 5, (0, 255, 0), -1)
            cv2.circle(img2_rgb, tuple(np.int32(p2).tolist()), 5, (0, 255, 0), -1)
        ...
        for line in lines1:
            ...
            cv2.line(img2_rgb, (x0, y0), (x1, y1), color, 1)
        ...
        for line in lines2:
            ...
            cv2.line(img1_rgb, (x0, y0), (x1, y1), color, 1)
    ...
    def get_disparity_map(self):
        return self.disparity_normalized
